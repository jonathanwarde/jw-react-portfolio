import './scss/components/_cv-link.scss';

const CVLink = () => {
    return (
        <a href="https://docs.google.com/presentation/d/1jw0WneUnRNT2m6QSK2qIchuUkpAtXxaWnnLlDoyY9mM/edit?usp=sharing" className="cv-link" target="_blank">
             <span>view CV</span>
