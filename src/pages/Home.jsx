const Home = (props) => {
    return (
        <div>
            ...
            <p>I currently work at digital agency <a href="https://7dots.co.uk" target="_blank">7dots</a> - who's clients inclide Coca-Cola, Aston Martin, ITV, and BupaCoca-Cola, Aston Martin, ITV, and Bupahold a Senior Developer position at 7dots.co.uk, building sites in both Wordpress and Silverstripe. My commitment is towards crafting not only functional but also visually appealing and accessible web solutions, staying at the forefront of both established and emerging web technologies.</p>
        </div>
    );
};
